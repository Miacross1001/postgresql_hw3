...
- с INSERT запросами (из предыдущей домашней работы) (db/INSERT.sql)
- с SELECT запросами (текущее задание) (db/SELECT.sql)
- с CREATE запросами (из второй домашней работы) (db/CREATE.sql)
